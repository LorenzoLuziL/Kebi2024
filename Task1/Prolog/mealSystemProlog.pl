...
meal(tagliatelle_allo_scoglio, first_dish, [salt, oil, pasta, shrimp, mussel, calamari, garlic, chili, tomato]).
meal(ramen, first_dish, [salt, oil, pasta, egg, pork_chop, garlic, black_pepper, water]).
meal(bistecca_alla_fiorentina, second_course, [salt, oil, steak]).
meal(pesce_fritto, second_course, [salt, oil, shrimp, calamari,cod]).
...
meal(pizza_margherita, main_dish, [salt, oil, mozzarella_cheese, tomato, water, type_0_flour]).
...
% QUERY EXAMPLES:
guest_preferences(vegetarian, 2, lactose, Meal, Course).


guest_preferences(vegetarian, 2, lactose, Meal, Course).


guest_preferences(carnivorous, 1, gluten, Meal, Course).


guest_preferences(omnivore, 3, none, Meal, Course).


guest_preferences(vegetarian, 0, gluten, Meal, Course).


guest_preferences(carnivorous, 3, lactose, Meal, Course).
